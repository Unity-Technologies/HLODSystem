...
namespace Unity.HLODSystem.Utils
{
    ...
    {
        public static WorkingCollider ToWorkingCollider(this Collider collider)
        {
            WorkingCollider wc = new WorkingCollider();
            dynamic parameters = wc.Parameters;

            wc.Type = collider.GetType().Name;
            wc.Position = collider.transform.position;
            wc.Rotation = collider.transform.rotation;
            wc.Scale = collider.transform.lossyScale;
            ...
            {
                parameters.SharedMesh = GUIDUtils.ObjectToGUID(meshCollider.sharedMesh);
